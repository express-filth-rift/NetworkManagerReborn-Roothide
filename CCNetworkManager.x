...
// Reference: CTTelephonyNetworkInfo.descriptors approach from DevelopCubeLab/CellularInfo
// Note: uses serviceSubscriberCellularProviders public API for build compatibility
...
static void writeSelectedNetwork() {
  ...
  [prefs writeToFile:
             @"/var/mobile/Library/Preferences/me.nixuge.networkmanager.plist"
          atomically:YES];
}
...
static void loadPrefs() {
  ...
  // Load current slot (default to 0)
  currentSlot = [[prefs objectForKey:@"currentSlot"] ?: @0 intValue];
